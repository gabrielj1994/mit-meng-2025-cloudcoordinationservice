...
public class ZKConfigs {
    ...
    public static final String PERSISTENCE_NODE = "/persistenceNode";
    public static final String TEMP_NODE = "/tempNodes";
    ...
    public static String getHostPostOfServer() {
        ...
        int port = Integer.parseInt(System.getProperty("msg.port"));
